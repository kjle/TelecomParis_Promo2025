...
public class PanneauTrace extends JPanel {	
	...
	// Convertit les coordonnées de P dans le repère Vue
	...
	// Inverse de la methode convertir
	...
	protected Couple vecteurDansVue(Couple P, Couple d) {
	...
	// Dessine le trajet
	protected void dessinerLeChemin(Graphics2D g) {
	...
	protected void paintComponent(Graphics g1) {
		...
		if (P == null) {
			...
			if ((descente != null) && !descente.atteintSonMinimum())  {
				this.dessinerLeChemin(g);	
