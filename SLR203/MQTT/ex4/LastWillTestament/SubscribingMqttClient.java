...
public class SubscribingMqttClient {//synchronous client
	...
	public static void main(String[] args) {
	    ...
	    try(
            ...
            // subscribe to a will topic
            System.out.println("Mqtt Client: Subscribing to will topic: " + willTopic);
            mqttClient.subscribe(willTopic, willQos);
            System.out.println("Mqtt Client: successfully subscribed to the will topic.");
